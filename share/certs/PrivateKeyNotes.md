...
unlocked to sign the Skyrus-Qt.app bundle.
...
allowing somebody to distribute a Skyrus-Qt.app or skyrus-qt-setup.exe with a valid
...
that the skyrus-qt.exe file inside the installer had not been tampered with.
