...
### Community Fund - Accumulation of coins, signaled by version bit 7:
  ...
  - Inclusion of an additional output in the Coinstake transaction contributing 0.25SKX to the Community Fund
...
- Accepts URI to sign messages.
    - URIs of the format skyrus:http://domain/something/?a=skyrus_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- skyrus-tx tool has been updated to use skyrus’s own transaction structure
