...
class SegWitTest(SkyrusTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--oldbinary", dest="oldbinary",
                          default=None,
                          help="pre-segwit skyrusd binary for upgrade testing")
    ...
    def setup_network(self):
        ...
        # If an old skyrusd is given, do the upgrade-after-activation test.
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, skyrusd delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let skyrusd fill it in.
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older skyrusd's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-skyrusd> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active skyrusd
