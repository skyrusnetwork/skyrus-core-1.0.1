...
class RawTransactionsTest(SkyrusTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid skyrus address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid skyrus address" in e.error['message'])
