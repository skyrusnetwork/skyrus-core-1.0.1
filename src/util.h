 ...
 */
#ifndef SKYRUS_UTIL_H
#define SKYRUS_UTIL_H
...
extern const char * const SKYRUS_CONF_FILENAME;
extern const char * const SKYRUS_PID_FILENAME;
...
{
    std::string s = strprintf("skyrus-%s", name);
