...
UniValue addanonserver(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("addanonserver", "\"192.168.0.6:52217\" \"add\"")
            + HelpExampleCli("addanonserver", "\"192.168.0.6:52217\" \"add\" true")
            + HelpExampleRpc("addanonserver", "\"192.168.0.6:52217\", \"remove\"")
            + HelpExampleRpc("addanonserver", "\"192.168.0.6:52217\", \"remove\", true")
        );
