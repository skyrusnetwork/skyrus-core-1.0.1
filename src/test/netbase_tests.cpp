...
{
    BOOST_CHECK(TestSplitHost("www.skyrus.org", "www.skyrus.org", -1));
    BOOST_CHECK(TestSplitHost("[www.skyrus.org]", "www.skyrus.org", -1));
    BOOST_CHECK(TestSplitHost("www.skyrus.org:80", "www.skyrus.org", 80));
    BOOST_CHECK(TestSplitHost("[www.skyrus.org]:80", "www.skyrus.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5556", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:5556", "::", 8333));
    BOOST_CHECK(TestSplitHost("::5556", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":5556", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:5556", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5556", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5556", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
