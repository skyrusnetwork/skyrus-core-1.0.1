...
#define BOOST_TEST_MODULE Skyrus Test Suite

#include "test_skyrus.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_skyrus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
