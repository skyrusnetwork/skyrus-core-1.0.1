...
#ifndef SKYRUS_TEST_SCRIPTNUM10_H
#define SKYRUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Skyrus Core 0.10.0, for cross-comparison.
 */
public:
