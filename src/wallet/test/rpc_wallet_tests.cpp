...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSkyrusAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSkyrusAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CSkyrusAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSkyrusAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSkyrusAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSkyrusAddress(arr[0].get_str()).Get() == demoAddress.Get());
