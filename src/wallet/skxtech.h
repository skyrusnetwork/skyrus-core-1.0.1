...
#ifndef SKYRUS_WALLET_SKXTECH_H
#define SKYRUS_WALLET_SKXTECH_H
...
#define SKXTECH_DEFAULT_INPUT_DELAY 1
#define SKXTECH_DEFAULT_OUT_DELAY 10
#define SKXTECH_DEFAULT_ENTROPY 4
