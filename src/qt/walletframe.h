...
#ifndef SKYRUS_QT_WALLETFRAME_H
#define SKYRUS_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, SkyrusGUI *_gui = 0);
    ~WalletFrame();
