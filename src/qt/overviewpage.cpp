...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(SkyrusUnits::SKX),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = SkyrusUnits::formatWithUnit(unit, amount, true, SkyrusUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SkyrusUnits::formatWithUnit(unit, balance, false, SkyrusUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SkyrusUnits::formatWithUnit(unit, unconfirmedBalance, false, SkyrusUnits::separatorAlways));
    ui->labelStaking->setText(SkyrusUnits::formatWithUnit(unit, stakingBalance, false, SkyrusUnits::separatorAlways));
    ui->labelImmature->setText(SkyrusUnits::formatWithUnit(unit, immatureBalance, false, SkyrusUnits::separatorAlways));
    ui->labelTotal->setText(SkyrusUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, SkyrusUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(SkyrusUnits::formatWithUnit(unit, aRange[i++].Total, false, SkyrusUnits::separatorAlways));
    ui->label7dStakingStats->setText(SkyrusUnits::formatWithUnit(unit, aRange[i++].Total, false, SkyrusUnits::separatorAlways));
    ui->label30dStakingStats->setText(SkyrusUnits::formatWithUnit(unit, aRange[i++].Total, false, SkyrusUnits::separatorAlways));
