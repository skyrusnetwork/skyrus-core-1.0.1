...
#ifndef SKYRUS_QT_SKYRUSUNITS_H
#define SKYRUS_QT_SKYRUSUNITS_H
...
/** Skyrus unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SkyrusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SkyrusUnits(QObject *parent);

    /** Skyrus units.
      @note Source: https://en.skyrus.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SKX,
...
typedef SkyrusUnits::Unit SkyrusUnit;

#endif // SKYRUS_QT_SKYRUSUNITS_H
