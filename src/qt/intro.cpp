...
void FreespaceChecker::check()
{
    ...
    try {
        ...
        if(fs::exists(dataDir))
        {
            ...
            {
                replyStatus = ST_OK;
                replyMessage = tr("Skyrus will try to import an old wallet.dat file.");
            } else {
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/skyrus"));
        ...
        while(true)
        {
            ...
            try {
                ...
                WriteConfigFile("addanonserver", "149.28.120.195:41377");
                WriteConfigFile("addanonserver", "45.32.127.152:41377");
     ...
     * override -datadir in the skyrus.conf file in the default data directory
     * (to be consistent with skyrusd behavior)
     */
