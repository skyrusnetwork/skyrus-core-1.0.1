...
#ifndef SKYRUS_QT_SENDCOINSDIALOG_H
#define SKYRUS_QT_SENDCOINSDIALOG_H
...
public Q_SLOTS:
    ...
    void checkSkxtechServers();
    void showSkxTechDialog();
...
#endif // SKYRUS_QT_SENDCOINSDIALOG_H
