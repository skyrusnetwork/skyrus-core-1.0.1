    ...
    mapper(0)
{
    ...
    ui->skyrusAtStartup->setToolTip(ui->skyrusAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->skyrusAtStartup->setText(ui->skyrusAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://chainz.cryptoid.info/skx/tx.dws?%s.htm");
#endif

    ui->unit->setModel(new SkyrusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->skyrusAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSkyrusConfButton_clicked()
{
